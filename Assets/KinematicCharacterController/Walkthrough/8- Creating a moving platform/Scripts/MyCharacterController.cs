...
namespace KinematicCharacterController.Walkthrough.MovingPlatform
{
    ...
    /// <summary>
    /// 自定义角色控制器核心类
    /// 实现ICharacterController接口，接管KCC的旋转、速度等核心逻辑
    /// </summary>
    public class MyCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        public bool OrientTowardsGravity = true; // 是否朝向重力方向（适配斜面/反重力场景）
        ...
        /// 【注意】这是唯一允许设置角色旋转的地方
        /// </summary>
        /// <param name="currentRotation">当前旋转（可修改）</param>
        /// <param name="deltaTime">帧时间增量</param>
        ...
        /// 【注意】这是唯一允许设置角色速度的地方
        /// </summary>
        /// <param name="currentVelocity">当前速度（可修改）</param>
        /// <param name="deltaTime">帧时间增量</param>
            ...
            // 跳跃逻辑处理
            {
                ...
                if (_jumpRequested)
                {
                        ...
                        (!_jumpConsumed && ((AllowJumpingWhenSliding ? Motor.GroundingStatus.FoundAnyGround : Motor.GroundingStatus.IsStableOnGround) || _timeSinceLastAbleToJump <= JumpPostGroundingGraceTime)))
                    {
                        ...
                        // 叠加跳跃速度（抵消当前垂直速度）
                        currentVelocity += (jumpDirection * JumpSpeed) - Vector3.Project(currentVelocity, jumpDirection);
                        _jumpRequested = false;
                        _jumpConsumed = true;
                        _jumpedThisFrame = true;
                    }
        ...
        /// <returns>是否有效（true=参与碰撞）</returns>
        ...
        /// <param name="hitStabilityReport">稳定性报告（可修改）</param>
